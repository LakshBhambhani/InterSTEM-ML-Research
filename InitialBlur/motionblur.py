...
if __name__ == '__main__':
    image = Image.open("../LungCancerDetection/data/test/image_831.jpg")
    k = Kernel()
    blurred = k.applyTo(image, keep_image_dim=True)
    blurred.save("../data/blurred_scans/test/image_831.jpg", "PNG")
